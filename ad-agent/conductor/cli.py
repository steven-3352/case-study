...
用法：
  ...
  python -m conductor.cli resume <片名>       恢复中断任务并跑下一步
  ...
  python -m conductor.cli retry  <片名> <step>
  python -m conductor.cli cost   <片名> [--json]
  python -m conductor.cli budget <片名> <hard_limit> [currency]
  python -m conductor.cli confirm-cost <片名> <job_id> [shot|batch]
