---
name: video-form-motion-design-ad
description: |
  [中文触发] SaaS 动效广告 · 产品发布动效 · UI 动效 · 功能展示 · 软件广告 · 图形动画. 任何 i2v/t2v 视频模型(grok-imagine/Seedance 2.0/Kling/Runway/Luma/Wan/HunyuanVideo/Veo)的此形态 prompt 都调此 skill. [EN] Generate motion design advertisement video prompts for software and tech companies using any i2v/t2v video model (grok-imagine/Seedance/Kling/Runway/Luma/Wan/HunyuanVideo/Veo). Use whenever the user wants to create a software product ad, SaaS promo, app launch video, tech demo, UI showcase, startup video, or motion graphics for a tech company. Triggers on: software ad, SaaS video, product launch, app promo, tech commercial, UI animation, motion design ad, startup video, product demo video, feature showcase, or any software/tech promotional video request. Use even for "make a video for my app" or "promo for our platform."
platforms:
  - claude-code
  - cursor
  - codex
