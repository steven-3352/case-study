---
name: video-form-cartoon
description: |
  [中文触发] 卡通 · 2D 动画 · 赛璐璐 · 手绘 · 扁平矢量 · 水彩 · 复古卡通 · rubber hose · motion graphics · vector animation. 任何 i2v/t2v 视频模型(grok-imagine/Seedance 2.0/Kling/Runway/Luma/Wan/HunyuanVideo/Veo)的此形态 prompt 都调此 skill. [EN] Generate cartoon and animation style video prompts for any i2v/t2v video model. Use whenever the user wants cartoon, 2D animation, cel-shaded, hand-drawn, illustrated, flat animation, or motion graphics animation style video. Triggers on: cartoon, animation, cel shading, hand-drawn, illustrated, flat design animation, vector animation, retro cartoon, rubber hose, motion graphics, or any cartoon/animated style request. Use even for vague requests like "make it look animated" or "fun colorful style."
platforms:
  - claude-code
  - cursor
  - codex
