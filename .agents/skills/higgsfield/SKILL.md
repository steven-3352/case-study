...
name: higgsfield
description: >
  [中文触发] Higgsfield · MCSLA 公式 · 视频/图像 prompt 元公式 · 模型对比 · 相机运动 · Soul ID 角色一致 · Cinema Studio · Vibe Motion · 生成失败诊断. 本项目**不订阅 Higgsfield 平台**,只用 prompt 能力/词典/公式. [EN] Use this skill whenever the user asks anything about Higgsfield AI — writing or
