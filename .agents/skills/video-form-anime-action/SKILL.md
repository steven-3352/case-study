---
name: video-form-anime-action
description: |
  [中文触发] 日漫 · 动漫 · 机甲 · 少年漫 · 少女漫 · isekai · 樱花 · chibi · kawaii · OP/ED · 日本动画风. 任何 i2v/t2v 视频模型(grok-imagine/Seedance 2.0/Kling/Runway/Luma/Wan/HunyuanVideo/Veo)的此形态 prompt 都调此 skill. [EN] Generate anime-style video prompts for any i2v/t2v video model. Use whenever the user wants anime, Japanese animation style, shonen action, seinen drama, magical girl, mecha, isekai, slice-of-life anime, or any Japanese animation aesthetic. Triggers on: anime, Japanese animation, shonen, seinen, manga style video, anime fight, anime opening, anime ending, sakura, chibi, kawaii, mecha, isekai, or any anime-style request. Use even for "make it look like an anime" or "Japanese cartoon style."
platforms:
  - claude-code
  - cursor
  - codex
