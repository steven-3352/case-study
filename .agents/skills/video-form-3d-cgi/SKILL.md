---
name: video-form-3d-cgi
description: |
  [中文触发] 3D 渲染 · CGI · Pixar 风 · Unreal Engine · Blender · Octane · 光线追踪 · 体积雾 · 次表面散射 · PBR · 照片级 3D. 任何 i2v/t2v 视频模型(grok-imagine/Seedance 2.0/Kling/Runway/Luma/Wan/HunyuanVideo/Veo)的此形态 prompt 都调此 skill. [EN] Generate 3D CGI and rendered video prompts for any i2v/t2v video model. Use whenever the user wants 3D rendered, CGI, Pixar-style, Unreal Engine, photorealistic 3D, computer-generated, or digitally rendered video content. Triggers on: 3D animation, CGI, rendered, Blender, Unreal Engine, octane render, ray tracing, volumetric, subsurface scattering, physically based rendering, or any 3D/CG video request. Always use even if the user just says "make it look 3D" or describes a rendered aesthetic.
platforms:
  - claude-code
  - cursor
  - codex
