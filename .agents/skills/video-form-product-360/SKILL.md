---
name: video-form-product-360
description: |
  [中文触发] 产品 360° · 转台展示 · 多角度 · 主视觉镜头 · 材质秀 · 商品旋转 · turntable. 任何 i2v/t2v 视频模型(grok-imagine/Seedance 2.0/Kling/Runway/Luma/Wan/HunyuanVideo/Veo)的此形态 prompt 都调此 skill. [EN] Generate product 360° turntable, multi-angle showcase, and product reveal video prompts for any i2v/t2v video model. Use whenever the user wants a product rotation video, turntable showcase, product reveal, 360 view, multi-angle product display, product beauty shot, hero product video, or unboxing reveal. Triggers on: product 360, turntable, product rotation, multi-angle, product reveal, product showcase, hero shot, beauty shot, product spin, unboxing, or any request to showcase a physical product from multiple angles. Use even for "show my product from all sides" or "make a product video."
platforms:
  - claude-code
  - cursor
  - codex
