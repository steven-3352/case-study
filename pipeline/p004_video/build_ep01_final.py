...
用法: ./.venv/bin/python pipeline/p004_video/build_ep01_final.py
"""
...
OUT = ROOT/"out"/"ep01full"
SCENES = OUT/"scenes"; SCENES.mkdir(parents=True, exist_ok=True)
FPS, W, H = 30, 1080, 1920
SCENE_IDS = ["s0_hook","s1_chatlog","s2_gitscar","s3_triquiz","s4_recap","s5_land"]
VO = OUT/"vo_master.wav"
SFX = OUT/"sfx_bed_full.wav"
SUBS = FRAMES/"ep01f_subs"
...
# 也出一版无 sfx(纯真声+字幕)备份
final_vo = OUT/"EP01_全长版_真声纯VO_抖音.mp4"
